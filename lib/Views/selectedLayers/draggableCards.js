...
const handleRemoveLayer = (event, properties) => {
  properties.viewState.terria.workbench.remove(properties.data);
};

function DraggableCard(props) {
  console.log(props);
  props.viewState.terria.workbench.items[0].availableStyles[0] &&
    console.log(
      props.viewState.terria.workbench.items[0].availableStyles[0].styles
    );
    ...
    >
        ...
        <Card sx={{ minWidth: 345, width: 345, backgroundColor: "#76a3de26" }}>
          ...
          <CardActions>
            ...
            <Button
              size="small"
              variant="contained"
              onClick={(e) => props.handleAboutItem(e, props.data)}
            >
              About Data
            </Button>
            {/* <Button size="small" variant="contained">
            ...
            <Button
              size="small"
              variant="contained"
              onClick={(e) => handleRemoveLayer(e, props)}
            >
              Remove
            </Button>
          </CardActions>
      ...
      /> */}
        ...
        /> */}
          ...
          <CardActions>
            <Legend item={props.data} />
            {props.data.uniqueId.includes("max") && (
              <div>
                <Button
                  size="small"
                  variant="contained"
                  onClick={(e) => props.handleEditRange(e, props.data)}
                >
                  Edit Range
                </Button>
              </div>
