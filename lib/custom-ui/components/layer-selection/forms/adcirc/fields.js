...
export const DateField = ({ formOptions, setDate }) => {
...
export const CycleField = ({ formOptions, setCycle }) => {
  const { control, formState } = useFormContext();
...
export const GridField = ({ formOptions, setGrid }) => {
  const { control, formState } = useFormContext();
...
export const InstanceField = ({ formOptions, setInstance }) => {
  const { control, formState } = useFormContext();
...
export const StormNameField = ({ formOptions, setStormName }) => {
  const { control, formState } = useFormContext();
      ...
      <Controller
        ...
        render={({ field }) => (
          <Select
            ...
            onChange={(data) => {
              field.onChange(data);
              setStormName(data.target.value);
            }}
          >
...
export const AdvisoryField = ({ formOptions, setAdvisory }) => {
  const { control, formState } = useFormContext();
