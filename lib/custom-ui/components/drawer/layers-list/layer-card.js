...
export const LayerCard = ({
  ...
  // console.log(layer.infoAsObject);
  ...
  return (
    ...
    >
      ...
      <CardContent className="layer-name">
        <p style={{ width: "100%", margin: 0, fontSize: "12px" }}>
          {layer.infoAsObject.WebMapServiceLayerDescription}
        </p>
        <p style={{ width: "100%", margin: 0, fontSize: "12px" }}>
