...
export const ActiveLayerDetails = ({ value2, setValue2 }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Typography
          variant="h6"
          sx={{ p: 2, fontSize: "18px", order: orderValue }}
        >
          {"Grid: " +
            activatedLayer.infoAsObject.GridType +
            " Forcast Type: " +
            activatedLayer.infoAsObject.EnsembleMember}
        </Typography>
        <Tabs
          value={currentTabIndex}
          onChange={handleClickTab}
          aria-label="Layer details tab selection"
          sx={{ minWidth: "400px", order: orderValue2 }}
        >
