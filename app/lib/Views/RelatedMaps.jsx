        ...
        <MenuPanel theme={dropdownTheme}
            ...
            <div className={classNames(PanelStyles.section, Styles.section)}>
                <a target="_blank" href="http://nationalmap.gov.au/renewables/">
                    <img className={Styles.image} src="../../app/images/aremi.jpg"
                         alt="AREMI"/>
                </a>
            ...
            <div className={classNames(PanelStyles.section, Styles.section)}>
                <a target="_blank" href="http://nationalmap.gov.au/northernaustralia/">
                    <img className={Styles.image} src="../../app/images/northernaustralia.jpg"
            ...
            <div className={classNames(PanelStyles.section, Styles.section)}>
                <a target="_blank" href="http://neiiviewer.nicta.com.au">
                    <img className={Styles.image} src="../../app/images/neii.jpg"
                         alt="NEII Viewer"/>
                </a>
            ...
            <div className={classNames(PanelStyles.section, Styles.section)}>
                <a target="_blank" href="http://map.aurin.org.au">
                    <img className={Styles.image} src="../../app/images/aurin-map.jpg"
                         alt="AURIN Map"/>
                </a>
